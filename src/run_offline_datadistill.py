...
def main(cfg: DictConfig):
    ...
    train_student_data_distillation_episodic_offline(student=student, teacher=teacher, env=env, loss_function=loss_function, data_path=data_path, optimizer=optimizer, rollout_buffer=rollout_buffer, synthetic_buffer=trainable_buffer, student_train_epochs=cfg.student_train_epochs, student_update_freq=cfg.student_update_freq, device=device, **distill_kwargs)
