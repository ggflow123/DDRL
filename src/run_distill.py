...
from training import train_student_episodic
...
def main(cfg: DictConfig):
    ...
    training_rewards = train_student_episodic(student=student, teacher=teacher, env=env,
                           loss_function=loss_function, 
                           optimizer=optimizer, rollout_buffer=rollout_buffer,
                           **distill_kwargs)
